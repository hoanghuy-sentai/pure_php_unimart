...
<div id="main-content-wp" class="info-account-page">
    <div class="section" id="title-page">
        <div class="clearfix">
            <h3 id="index" class="fl-left" style="margin-left: 20px;">Cập nhật người dùng</h3>
        </div>
    </div>
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">                       
            <div class="section" id="detail-page">
                ...
                <form method="POST" action="?mod=home&controller=infoAccount&action=update&id=<?php echo $user['id'] ?>">
                        <label for="name">Tên hiển thị</label>
                        <input type="text" name="name" value="<?php echo $user['name']  ?>"  placeholder="" id="display-name">
                        ...
                        <input type="email" name="email" id="email" value="<?php echo $user['email'] ?>" placeholder="" readonly>
                        ...
                        <select name="role" id="role" >
                            ...
                            <?php 
                                ...
                                {
                            ?>
                                 <option value="<?php $key=$key+1; echo $key ?>" <?php echo $user['role_id']==$key?'selected':'' ?> ><?php echo $vlue['rolename']  ?></option>
                            <?php 
                                }
                            ?>
                        </select>
