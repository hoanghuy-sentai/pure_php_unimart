        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST" action="?mod=product&controller=AdminProduct&action=add" enctype="multipart/form-data">
                        ...
                        <label for="price">Số lượng sản phẩm sản phẩm</label>
                        ...
                        <div id="uploadFile">
                            <input type="radio" name="productFeature" value="0">Có       
                            <input type="radio" name="productFeature" value="1" checked id="price">Không
                        </div>
