        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST" action="?mod=post&controller=AdminPost&action=edit&id=<?php echo $id  ?>" enctype="multipart/form-data">
                        ...
                        <div id="uploadFile">
                            ...
                            <input type="hidden" name="file_" value="<?php echo $post_thumb ?>">
                        </div>
